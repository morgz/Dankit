...
- (void)viewDidLoad {
	...
	self.navBar.topItem.title = @"Signup";
	...
	self.navBar.topItem.rightBarButtonItem = signUpButton;
...
-(IBAction)signUp {
	...
	[[UserManager sharedManager]signUpWithUsername:self.username andPassword:self.password];
